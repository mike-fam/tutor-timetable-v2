...
export type GetOffersByUserIdQueryVariables = Exact<{ [key: string]: never; }>;


export type GetOffersByUserIdQuery = (
  { __typename?: 'Query' }
  & { getOffersByUserId: Array<(
    { __typename?: 'Offer' }
    & Pick<Offer, 'id'>
    & { preferences: Array<(
      { __typename?: 'Session' }
...
export const GetOffersByUserIdDocument = gql`
    query getOffersByUserId {
  getOffersByUserId {
    id
    preferences {
      id
...
/**
 * __useGetOffersByUserIdQuery__
 *
 * To run a query within a React component, call `useGetOffersByUserIdQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetOffersByUserIdQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetOffersByUserIdQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetOffersByUserIdQuery(baseOptions?: Apollo.QueryHookOptions<GetOffersByUserIdQuery, GetOffersByUserIdQueryVariables>) {
        return Apollo.useQuery<GetOffersByUserIdQuery, GetOffersByUserIdQueryVariables>(GetOffersByUserIdDocument, baseOptions);
      }
export function useGetOffersByUserIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetOffersByUserIdQuery, GetOffersByUserIdQueryVariables>) {
          return Apollo.useLazyQuery<GetOffersByUserIdQuery, GetOffersByUserIdQueryVariables>(GetOffersByUserIdDocument, baseOptions);
        }
export type GetOffersByUserIdQueryHookResult = ReturnType<typeof useGetOffersByUserIdQuery>;
export type GetOffersByUserIdLazyQueryHookResult = ReturnType<typeof useGetOffersByUserIdLazyQuery>;
export type GetOffersByUserIdQueryResult = Apollo.QueryResult<GetOffersByUserIdQuery, GetOffersByUserIdQueryVariables>;
